        ...
        <table role="table">
          ...
          <tbody role="rowgroup">
            ...
            <tr role="row">
              ...
              <td role="cell">
                <a href="{{url('modificausuario',['id_usuario'=>$u->id_usuario])}}" class="btn btn-light"> Modificar<img
                    src="{{asset('icons/062-pencil.png')}}" width="20" height="20"></a>
              </td>
              <td role="cell">

                <a href="{{url('eliminauser',['id_usuario'=>$u->id_usuario])}}"
                  class="Eliminar btn btn-outline-danger">Eliminar
                  <img src="{{asset('icons/019-close.png')}}" width="20" height="20"></a>
              </td>
              <td role="cell">

                <a href="{{url('restableceruser',['id_usuario'=>$u->id_usuario])}}"
                  class="Restaurar btn btn-outline-dark">
